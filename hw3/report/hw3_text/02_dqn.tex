...
\end{lstlisting}
          ...
          \begin{center}
              ...
              \begin{minipage}{0.48\linewidth}
                  \centering
                  \includegraphics[width=\linewidth]{imgs/lunarlander_train_return.png}
              \end{minipage}

              \vspace{0.1cm}
              {\footnotesize LunarLander DQN results across 3 seeds. Left: Eval return. Right: Train return.}
          \end{center}
