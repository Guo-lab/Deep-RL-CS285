...
"""
Docstring for cs285.agents.soft_actor_critic

we build on the SAC implementation from HW3
and use the learned model we implemented in the earlier questions
for generating additional samples to train
our SAC agent.
